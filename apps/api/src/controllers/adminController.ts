...
export class AdminController {
   ...
   */
  public static triggerNewsFetch = asyncHandler(
   ...
   */
  public static getFetchStatus = asyncHandler(
    async (req: Request, res: Response, _next: NextFunction) => {
   ...
   */
  public static getFetchLogs = asyncHandler(
    async (req: Request, res: Response, _next: NextFunction) => {
   ...
   */
  public static getFetchStatistics = asyncHandler(
    async (req: Request, res: Response, _next: NextFunction) => {
      const stats = await FetchLog.getStatistics();
   ...
   */
  public static clearNewsCache = asyncHandler(
    async (req: Request, res: Response, _next: NextFunction) => {
   ...
   */
  public static getCacheStats = asyncHandler(
    async (req: Request, res: Response, _next: NextFunction) => {
   ...
   */
  public static getDatabaseStats = asyncHandler(
    async (req: Request, res: Response, _next: NextFunction) => {
   ...
   */
  public static getSystemHealth = asyncHandler(
    async (req: Request, res: Response, _next: NextFunction) => {
      const health = {
        status: 'healthy',
        timestamp: new Date().toISOString(),
      ...
      try {
        ...
        health.services.mongodb.status = health.services.mongodb.connected
          ? 'healthy'
          : 'unhealthy';
      } catch (error) {
   ...
   */
  public static getArticleStats = asyncHandler(
    async (req: Request, res: Response, _next: NextFunction) => {
   ...
   */
  public static deleteArticle = asyncHandler(
    async (req: Request, res: Response, _next: NextFunction): Promise<void> => {
      const { id } = req.params;
   ...
   */
  public static stopScheduledJob = asyncHandler(
    async (req: Request, res: Response, _next: NextFunction) => {
