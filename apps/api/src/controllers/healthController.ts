...
export class HealthController {
   ...
   */
  public static healthCheck = asyncHandler(async (req: Request, res: Response) => {
    const healthData = {
      status: 'healthy',
   ...
   */
  public static detailedHealthCheck = asyncHandler(async (req: Request, res: Response) => {
   ...
   */
  public static readinessCheck = asyncHandler(async (req: Request, res: Response) => {
   ...
   */
  public static livenessCheck = asyncHandler(async (req: Request, res: Response) => {
